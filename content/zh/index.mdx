...
Nixpkgs 25.11 "Xantusia" 已于 2025 年 11 月 30 日发布。根据 [Release Notes](https://nixos.org/manual/nixpkgs/stable/release-notes#sec-nixpkgs-release-25.11)，龙架构原生编译的初步支持工作已经完成，更多改进正在准备中。

根据 [Software Development and Build Convention for LoongArch™ Architectures](https://github.com/loongson/la-softdev-convention)，此版本将默认的 `march` 级别设置为 `la64v1.0`，覆盖了 3A5000 以及更新系列的桌面和服务器处理器，但不支持没有 LSX 扩展的平台，如 2K0300。您可以使用 `pkgsCross.loongarch64-linux-embedded` 为平台构建软件和系统。

未来，我们将持续推进 Nixpkgs 各大软件包的适配工作，不断提升龙架构上可用软件包的数量和质量。
...
请勿将本项目与 [Loongnix](https://www.loongnix.cn/zh/) 混淆，后者为龙芯开源社区推出的 Linux 发行版。本项目由社区组织 [loongson-community](https://github.com/loongson-community/) 发起，请勿将本组织与龙芯中科的龙芯开源社区和[龙芯爱好者社区](https://loongfans.cn/)等组织混淆。
